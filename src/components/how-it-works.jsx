...
const HowItWorks = () => {
  return (
    <Card>
      <CardHeader>
        <Heading size="lg">Here&apos;s how fundraising works on DaanGo</Heading>
      </CardHeader>
      <CardBody>
          ...
          <OrderedList spacing="24px">
            <ListItem className="space-y-6">
              ...
              <UnorderedList spacing="10px">
                ...
                <ListItem>Set your fundraising goals, and remember you can always change it later</ListItem>
              </UnorderedList>
            </ListItem>
            <ListItem className="space-y-6">
            ...
            <ListItem className="space-y-6">
              <Heading size="md">Post updates</Heading>
              <UnorderedList spacing="10px">
                <ListItem>
            ...
            <ListItem className="space-y-6">
              ...
              <UnorderedList spacing="10px">
                ...
                <ListItem>
                  Once you have added your bank details you can also donate to other fundraisers.
                </ListItem>
              </UnorderedList>
            </ListItem>
          </OrderedList>
